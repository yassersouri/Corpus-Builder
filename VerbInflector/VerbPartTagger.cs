...
namespace VerbInflector
{
   public class VerbPartTagger
       ...
       /// <returns></returns>
            public static Dictionary<int, KeyValuePair<string, object>> Manage(string[] sentence, string[] posSentence, out string[] posTokens, string[] lemmas, out string[] outlemmas,string verbDicPath)
            {
                var bestDic = new Dictionary<int, KeyValuePair<string, object>>();
                var initDic = GetVerbTokens(sentence,posSentence,out posTokens,lemmas,out outlemmas, verbDicPath);
       ...
       /// <returns></returns>
            public static Dictionary<int, KeyValuePair<string, object>> ManageConsiderCompoundVerbs(string[] sentence, string[] posSentence, out string[] posTokens,string[] lemmas, string verbDicPath)
            {
           string[] outlemmas;
                var bestDic = Manage(sentence, posSentence, out posTokens,lemmas, out outlemmas,verbDicPath);
...
/// <returns></returns>
     public static Dictionary<int, KeyValuePair<string, KeyValuePair<int, object>>> MakePartialTree(string[] sentence, string[] posSentence, out string[] posTokens, string[] lemmas, string verbDicPath)
     {
         var dic = ManageConsiderCompoundVerbs(sentence, posSentence, out posTokens,lemmas, verbDicPath);
     ...
     public static Dictionary<int, KeyValuePair<string, KeyValuePair<int, object>>> MakePartialTree(string[] sentence,  string verbDicPath)
     {
       ...
       private static Dictionary<int, List<int>> GetGoodResult(string[] sentence, string[] posSentence,string verbDicPath)
            ...
            private static Dictionary<int, KeyValuePair<string, int>> GetOutputResult(string[] sentence, string[] posSentence,out string[]newPOSTokens,string[] lemmas, out string[] outLemmas,string verbDicPath)
            {
